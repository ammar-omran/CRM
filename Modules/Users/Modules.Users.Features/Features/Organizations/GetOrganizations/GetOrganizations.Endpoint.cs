...
using Modules.Users.Features.Organizations.Shared.Routes;

namespace Modules.Users.Features.Organizations.GetOrganizations;

public class GetOrganizationsEndpoint : IApiEndpoint
{
    ...
    private static async Task<IResult> Handle(
        [AsParameters] GetOrganizationRequest request,
        IValidator<GetOrganizationRequest> validator,
        IGetOrganizationsHandler handler,
