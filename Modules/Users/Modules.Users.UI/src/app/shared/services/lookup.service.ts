...
export class LookupService {
  ...
  getTicketFilters(name: string): Observable<BaseResponse<LookupListDto[]>> {
    return this.http.get<BaseResponse<LookupListDto[]>>(`${environment.ApiUrl}/Ticket/lookup/${name}`);
  }
}
