    ...
    public partial class InitUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PairentRoleId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_Roles_PairentRoleId",
                        column: x => x.PairentRoleId,
            ...
            migrationBuilder.InsertData(
                schema: "users",
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName", "PairentRoleId" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_PairentRoleId",
                schema: "users",
                table: "Roles",
                column: "PairentRoleId");
