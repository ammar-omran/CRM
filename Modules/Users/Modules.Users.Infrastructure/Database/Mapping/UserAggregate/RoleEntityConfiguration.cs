...
public class RoleConfiguration : IEntityTypeConfiguration<Role>
{
	public void Configure(EntityTypeBuilder<Role> builder)
	{
		...
		builder.HasData([
				...
				new Role { Id = "4", Name = "Team Lead", PairentRoleId = "1", NormalizedName = "TeamLead", ConcurrencyStamp = "bf4d84e9-fb60-458f-b176-d6d9e94e1218" },
				new Role { Id = "5", Name = "First Line", PairentRoleId = "1", NormalizedName = "FirstLine", ConcurrencyStamp = "afdb8cfc-85ee-471e-9dbc-4508ba2ef533" },
				new Role { Id = "6", Name = "Second Line", PairentRoleId = "1", NormalizedName = "SecondLine", ConcurrencyStamp = "e647f1a9-a664-4269-8c3d-20401c1dccd5" },
			]);
	}
}
