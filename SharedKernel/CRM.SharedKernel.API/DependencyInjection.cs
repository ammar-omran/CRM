...
using CRM.SharedKernel.API.ErrorHandling;
using Serilog;
...
{
  public static IServiceCollection AddCoreWebApiInfrastructure(this IServiceCollection services, string moduleName)
  {
	services
